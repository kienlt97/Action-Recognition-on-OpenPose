    ...
    if bboxes:
        ...
        for d in trk_result:
            ...
            if joints_norm_per_frame.size > 0:
                ...
                joints_norm_single_person = np.reshape(joints_norm_single_person, (joints_norm_single_person.shape[0],1, joints_norm_single_person.shape[1]))
                ...
                if init_label == 'fall_down':
                    cv.putText(frame, 'WARNING: someone is falling down!', (20, 60), cv.FONT_HERSHEY_SIMPLEX,
                               1.5, (0, 0, 255), 4)
                    cv.rectangle(frame, (xmin - 10, ymin - 30), (xmax + 10, ymax), (0, 0, 255), 2)   
                    count = 1
                else:
                    # 画track_box
                    count = 0
                    cv.rectangle(frame, (xmin - 10, ymin - 30), (xmax + 10, ymax), (0, 255, 0), 2)
